...
public class StatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load(Student.getInstance().photo).into(imageView);
        ...
        BtnFindFriend.setOnClickListener(view -> {
            ...
            String[] c = {"age", "major", "living", "space1", "space2", "language", "food", "hobby"};
            ...
            for(int i = 0; i < 8; i++){
                ...
                map.put("category_info", c[i]);
                map.put("profile_info", Student.getInstance().profile_info[i]);
                Log.d("profileTag",Student.getInstance().profile_info[i] );
